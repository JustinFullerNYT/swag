...
[![GoDoc](https://godoc.org/marwan.io/swag?status.svg)](https://godoc.org/marwan.io/swag)
...
Refer to the [godoc](https://godoc.org/marwan.io/swag/endpoint) for a list of all the endpoint options
